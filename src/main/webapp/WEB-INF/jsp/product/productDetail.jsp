...
<div class="weui-content">
    ...
    <div class="weui-tab">
        <div class="weui-navbar" style="position:fixed; top:0; left:0; right:0; height:44px;">
            ...
            <a class="weui-navbar__item proinfo-tab-tit" href="#tab3">评论</a>
        </div>
        <div class="weui-tab__bd proinfo-tab-con">
            <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
                ...
                <div class="swiper-container swiper-zhutu">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="/img/upload/zhutu01.jpg"/></div>
                        <div class="swiper-slide"><img src="/img/upload/zhutu02.jpg"/></div>
                        <div class="swiper-slide"><img src="/img/upload/zhutu03.jpg"/></div>
                        <div class="swiper-slide"><img src="/img/upload/zhutu04.jpg"/></div>
                        <div class="swiper-slide"><img src="/img/upload/zhutu05.jpg"/></div>
                    </div>
                    <div class="swiper-pagination swiper-zhutu-pagination"></div>
                </div>
                <div class="wy-media-box-nomg weui-media-box_text">
                    <h4 class="wy-media-box__title">${product.product_name}</h4>
                    <div class="wy-pro-pri mg-tb-5">¥<em class="num font-20">${product.price}</em></div>
                    <p class="weui-media-box__desc">${product.intro}</p>
                </div>
            ...
            <div id="tab2" class="weui-tab__bd-item ">
                <div class="pro-detail">
                    <img src="/img/upload/xq1.jpg"/><img src="/img/upload/xq2.jpg"/><img src="/img/upload/xq3.jpg"/><img
                        src="/img/upload/xq4.jpg"/><img src="/img/upload/xq5.jpg"/><img src="/img/upload/xq6.jpg"/><img
                        src="/img/upload/xq7.jpg"/><img src="/img/upload/xq8.jpg"/><img src="/img/upload/xq9.jpg"/>
                </div>
            </div>
            <div id="tab3" class="weui-tab__bd-item">
                ...
                <div class="weui-panel__bd">
                    <div class="wy-media-box weui-media-box_text">
                        <div class="weui-cell nopd weui-cell_access">
                            <div class="weui-cell__hd"><img src="/img/upload/headimg.jpg" alt=""
                        ...
                        <ul class="weui-uploader__files clear mg-com-img">
                            <li class="weui-uploader__file" style="background-image:url(./img/upload/pro3.jpg)"></li>
                            <li class="weui-uploader__file" style="background-image:url(./img/upload/pro3.jpg)"></li>
                            <li class="weui-uploader__file" style="background-image:url(./img/upload/pro3.jpg)"></li>
                        </ul>
                    </div>
                ...
                <div class="weui-panel__bd">
                    <div class="wy-media-box weui-media-box_text">
                        ...
                        <p class="weui-media-box__desc">面料不错，码数也正常 男朋友面料不错，码数也正常 男朋友穿的面料不错，码数也正常 男朋友穿的穿的很合适。</p>
                        <ul class="weui-uploader__files clear mg-com-img">
                            <li class="weui-uploader__file" style="background-image:url(../img/upload/pro3.jpg)"
                                onclick="window.location.reload('gallery.html')"></li>
                            <li class="weui-uploader__file" style="background-image:url(../img/upload/ban2.jpg)"
                                onclick="window.location.reload('gallery.html')"></li>
                            <li class="weui-uploader__file" style="background-image:url(../img/upload/pro3.jpg)"
                                onclick="window.location.reload('gallery.html')"></li>
                        </ul>
...
<div class="weui-tabbar wy-foot-menu">
    ...
    <a href="shopcart.html" class="promotion-foot-menu-items">
        <span class="weui-badge" style="position: absolute;top: -.2em;right: 0.8em;">8</span>
